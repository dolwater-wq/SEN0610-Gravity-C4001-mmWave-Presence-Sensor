...
- `examples/storozhListen4Sensors.ino` — одновременное прослушивание 4 датчиков (RX/TX: 2/1, 3/4, 5/6, 11/10) с выводом сырого UART потока в Serial Monitor. Для 4-го канала нужен software UART (рекомендуется библиотека EspSoftwareSerial).
