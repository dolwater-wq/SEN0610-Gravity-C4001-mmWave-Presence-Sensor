...
- `examples/zorkiyGlaz.ino` — «Зоркий глаз»: быстрое последовательное прослушивание 4 датчиков по кругу (1/2, 4/3, 6/5, 10/11) при постоянном питании; выводит компактную сводку TARGET (none/ count/range/speed/energy) и имеет авто-попытку swap RX/TX для молчащего канала.
