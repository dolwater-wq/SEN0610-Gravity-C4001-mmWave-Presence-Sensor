...
- `examples/zorkiyGlaz.ino` — «Зоркий глаз»: быстрое последовательное прослушивание 4 датчиков по кругу (2/1, 3/4, 5/6, 10/11) при постоянном питании датчиков; есть авто-попытка swap RX/TX для молчащего канала.
