...
- `examples/zorkiyGlaz.ino` — «Зоркий глаз»: быстрое последовательное прослушивание 4 датчиков по кругу (1/2, 4/3, 6/5, 10/11) при постоянном питании; выводит компактные FRAME-строки и имеет авто-попытку swap RX/TX для молчащего канала.
